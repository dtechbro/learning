...
<section class="quick-view">
    ...
    <?php
    $pid = $_GET['pid'];
    $select_assignment = $conn->prepare("SELECT * FROM `assignment` WHERE id = ?");
    $select_assignment->execute([$pid]);
    ...
    <form action="" method="POST" class="box">
        ...
        <input type="hidden" name="username" value="<?= $fetch_assignment['username']; ?>">
        <input type="hidden" name="department" value="<?= $fetch_assignment['department']; ?>">
        <input type="hidden" name="topic" value="<?= $fetch_assignment['topic']; ?>">
        <input type="hidden" name="image" value="<?= $fetch_assignment['image_01']; ?>">
        ...
        <div class="content">
            ...
            <span><? $fetch_assignment['department']; ?></span>
            <div class="name"><?= $fetch_assignment['department']; ?></div>
            <div class="name"><?= $fetch_assignment['topic']; ?></div>
            <!-- <div class="flex">
                <div class="price">$<span><?= $fetch_assignment['price']; ?></span>/-</div>
            ...
            <input type="submit" value="Answer" name="answer" class="outer-btn">
        </div>
    </form>
    <?php
    }
