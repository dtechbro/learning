...
if(isset($_POST['add_product'])) {
    ...
    $select_products = $conn->prepare("SELECT * FROM `assignment` WHERE topic = ?");
    $select_products->execute([$topic]);
    ...
    if($select_products->rowCount() > 0) {
        ...
        if($image_01_size > 2000000 OR $image_02_size > 2000000 OR $image_03_size > 2000000) {
            ...
            $insert_product = $conn->prepare("INSERT INTO `assignment`(username, department, topic, details, image_01, image_02, 
            image_03) VALUES(?,?,?,?,?,?,?)");
            $insert_product->execute([$username, $department, $topic, $details, $image_01, $image_02, $image_03]);
...
if(isset($_GET['delete'])) {
    ...
    $delete_product_image = $conn->prepare("SELECT * FROM `assignment` WHERE id = ?");
    $delete_product_image->execute([$delete_id]);
    $fetch_delete_image = $delete_product_image->fetch(PDO::FETCH_ASSOC);
    unlink('../uploaded_img/'.$fetch_delete_image['image_01']);
    unlink('../uploaded_img/'.$fetch_delete_image['image_02']);
    unlink('../uploaded_img/'.$fetch_delete_image['image_03']);
    $delete_product = $conn->prepare("DELETE FROM `assignment` WHERE id = ?");
...
<head>
    ...
    <title>Lecturer - Assignment</title>
</head>
<body>
...
<h1 class="heading">Post Assignment</h1>
    ...
    <?php
        ...
        <div class="flex">
            <div class="inputBox">
                ...
                <input type="text" placeholder="Enter Department" name="username" value="<?= $fetch_profile['username']; ?>" maxlength="100" class="box" required>
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>Topics (required)</span>
                <input type="text" placeholder="Enter Topic" maxlength="100" name="topic" class="box" required>
            </div>
            <div class="inputBox">
            ...
            <input type="submit" value="Post Assignment" name="add_product" class="outer-btn">
        </div>
    </form>
...
<section class="show-products" style="padding-top: 0;">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="flex-btn">
                <a href="update_assignment.php?update=<?= $fetch_assignment['id']; ?>" class="option-btn">Update</a>
                <a href="assignment.php?delete=<?= $fetch_assignment['id']; ?>" 
                class="delete-btn" onclick="return confirm('Are you sure you want to delet this Assignment')">Delete</a>
            </div>
        </div>
        <?php }
        }
