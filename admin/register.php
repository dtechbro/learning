    ...
    if($select_admin->rowCount() > 0){
       $message[] = 'Lecturer already exist';
        ...
        if($password != $confirm_password) {
            ...
            $message[] = 'Passsword must be at least 8 digit';
        }else {
            $insert_admin = $conn->prepare("INSERT INTO `admins` (username, email, password, confirm_password) VALUES(?,?,?,?);");
            $insert_admin->execute([$username, $email, $password, $confirm_password]);
    ...
    <div class="container">
        <form action="" method="POST">
            <div class="logo text-center">
                ...
                <h4>Fulltime Lecturer Sign Up</h4>
            </div>
            <?php
            if(isset($message)) {
            ...
            <input type="password" name="password" id="form1Example3" class="form-control" />
            </div>
